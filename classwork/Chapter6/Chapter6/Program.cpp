...
//Do NOT DO THIS
//int g_thisIsAGloabalVariable = 100;
...
void ArrayDemo()
{
    ...
    /*daysInMonth[0] = daysInMonth[2] = daysInMonth[4] = daysInMonth[6] = daysInMonth[7] = daysInMonth[9]
                  = daysInMonth[11] = 31;
     daysInMonth[1] = 28;
    ...
    // Access elements
    // CAN'T
    //int numbers2[MaxNumbers] = numbers; //Assigment, have to manually copy using a for
    int numbers3[MaxNumbers] = {0};
    bool areArraysEqual = numbers == numbers3; //Comparison doesn't work, (in)equality complies but doesn't work
